 ...
 * @version 1.0.0
 */
public class AsyncMergeSort extends RecursiveAction {
  ...
  public AsyncMergeSort(int[] arrayForSort) {
  ...
  public void compute() {
    ...
    ForkJoinTask.invokeAll(new AsyncMergeSort(leftArray), new AsyncMergeSort(rightArray));
